        ...
        selection.each(function(data) {
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                if (allData.length > 2) {
                    ...
                    var indexToHighlight = nv.nearestValueIndex(allData.map(function(d){if (d.value) return d.value; else return null;}),yValue,threshold);
...
nv.models.line = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0}
        ...
        , getX = function(d) { if (d === undefined) return; else return d.x } // accessor to get the x value from a data point
        , getY = function(d) { if (d === undefined) return; else return d.y } // accessor to get the y value from a data point
